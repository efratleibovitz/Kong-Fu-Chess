...
Every message sent or received is logged to client/logs/client.log via
log_sent/log_received, which main_network.py also reuses for the raw
matchmaking/room handshake sockets it opens outside of this class - one
logger/file for the whole client instead of a second logging setup.
"""
